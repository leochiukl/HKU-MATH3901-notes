...
cost} of \(x_j\) (at \(\vect{x}\)). Then, \(\vect{x}\in P\) is optimal if
...
\ge 0.
\end{align*}
Thus, by \Cref{prp:optimal-iff-nonneg-feas-dir} we conclude that \(\vect{x}\) is optimal.
\end{pf}
...
process.
\item It can be shown that, as long as the feasible set is nonempty and every

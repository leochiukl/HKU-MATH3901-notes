...
=\{\vect{x}\in\R^n:\vect{a}_j^{T}\vect{x}\ge\vect{b}\text{ for all \(j=1,\dotsc,m\)}\}
=\bigcap_{j=1}^{m}\{\vect{x}\in\R^n:\vect{a}_j^{T}\vect{x}\ge\vect{b}\}.
\]
...
Agreeing with our geometrical intuition, a polyhedron is indeed convex.

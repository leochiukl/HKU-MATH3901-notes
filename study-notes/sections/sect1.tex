...
\end{tikzpicture}
\end{center}
In general, the feasible set of \emph{every} LP problem is a polyhedron,
...
constraints). Such basic solution with more than \(n\) active constraints (or
equivalently, with some basic variables being \(0\)) is called
...
linearly independent without changing the feasible set, or (ii) the feasible set is
